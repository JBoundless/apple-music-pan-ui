   ...
   animatedImageHeight = this.animation.y.interpolate({
    ...
    return(
      <Animated.View style={{flex: 1, backgroundColor: 'white'}}>
        <Animated.View {... this.panResponder.panHandlers} style={[animatedHeight, {position: 'absolute', left: 0, right: 0, zIndex: 10,backgroundColor: 'white', height: SCREEN_HEIGHT}]}>
        <ScrollView scrollEnabled={this.state.isScrollEnabled} scrollEventThrottle={16} onScroll={event=>{
          ...
          <Animated.View style={{height: animatedHeaderHeight, borderTopWidth: 1, borderTopColor: '#ebe5e5', flexDirection: 'row', alignItems: 'center'}}>
            <View style={{flex: 4, flexDirection: 'row', alignItems: 'center'}}>
              ...
              <Image style={{flex: 1, width: null, height: null}} source={{uri: 'https://i.pinimg.com/originals/eb/44/b3/eb44b3b1788d1782fa53bb09ed4aade8.jpg'}}></Image>
              </Animated.View>
              <Animated.Text style={{opacity: animatedSongTitleOpacity, fontSize: 18, paddingLeft: 10}}>Waving Through a Window</Animated.Text>
            </View>
        ...
        <Animated.View style={{height: animatedHeaderHeight, opacity: animatedSongDetailsOpacity}}>
          <View style={{flex: 1, alignItems: 'center', justifyContent: 'flex-end'}}>
            <Text style={{fontWeight: 'bold', fontSize: '22'}}>Waving Through a Window</Text>
            <Text style={{fontSize: 18, color: '#fa95ed'}}>Andrew Barth Feldman, 2019 Broadway Cast of Dear Evan Hansen</Text>
          </View>
          <View
                                style={{
                                    height: 40,
